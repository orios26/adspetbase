...
public class newDogVaccinationController {
    ...
    @FXML //fx:id ="vStart2"
    private DatePicker vStart2;

    @FXML //fx:id ="vStart3"
    private DatePicker vStart3;
    ...
    @FXML //fx:id ="vEnd2"
    private DatePicker vEnd2;

    @FXML //fx:id ="vEnd3"
    private DatePicker vEnd3;
    ...
    public void getVaccData()throws SQLException{
        ...
        addVacc(1,PID,vStart2.getValue(),vEnd2.getValue());
        addVacc(3,PID,vStart3.getValue(),vEnd3.getValue());
